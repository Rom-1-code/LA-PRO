...
<body>
    ...
    <xmp>
        <h2>Test Formulaire</h2>
        <php //Test de la va variable GET LeChiffre if (isset($_GET['LeChiffre']) && !empty($_GET['LeChiffre'])){ echo "Ma valeur est :" .$_GET['LeChiffre']; }else{ echo "Formulaire non saisie" ; ?>
            <form action="exoForm.php" method="GET">
                <label>Votre Chiffre</label>
